...
Blockly.CSharp.math = {};
Blockly.CSharp.math_number = function(a) {
    return [parseFloat(a.getFieldValue("NUM")), Blockly.CSharp.ORDER_ATOMIC]
};
Blockly.CSharp.texts = {};
Blockly.CSharp.text = function(a) {
    return [Blockly.CSharp.quote_(a.getFieldValue("TEXT")), Blockly.CSharp.ORDER_ATOMIC]
};