...
Ext.grid.filter.BooleanFilter = Ext.extend(Ext.grid.filter.Filter, {
    ...
    var gId = Ext.id();
		this.options = [
			new Ext.menu.CheckItem({text:this.displayText.yes, group: gId, checked: this.defaultValue === true}),
			new Ext.menu.CheckItem({text:this.displayText.no, group: gId, checked: this.defaultValue === false})
    ];
...
Ext.grid.filter.DateFilter = Ext.extend(Ext.grid.filter.Filter, {
	...
	init: function() {
		...
		var dates = this.dates = {
			'before': new Ext.menu.CheckItem({text: this.displayText.before, menu: new Ext.menu.DateMenu(opts)}),
			'after':  new Ext.menu.CheckItem({text:this.displayText.after, menu: new Ext.menu.DateMenu(opts)}),
			'on':     new Ext.menu.CheckItem({text: this.displayText.on, menu: new Ext.menu.DateMenu(opts)})
    };
...
Ext.grid.filter.StringFilter = Ext.extend(Ext.grid.filter.Filter, {
	...
	icon:'/web/aspx/resources/images/default/grid/icon5.gif',
	init: function() {
