...
Blockly.Blocks.colour_picker = {
    init: function() {
        ...
        this.setTooltip(function() {
            var b = a.getParent();
            return b && b.tooltip || Blockly.Msg.COLOUR_PICKER_TOOLTIP
        })
    }
};
...
Blockly.Blocks.lists_create_with = {
    ...
    compose: function(a) {
        ...
        this.updateShape_();
        for (b = 0; b < this.itemCount_; b++) a[b] && this.getInput("ADD" + b).connection.connect(a[b])
    },
    ...
    updateShape_: function() {
        ...
        else for (var a = 0; this.getInput("ADD" + a);) this.removeInput("ADD" + a),
        a++;
...
Blockly.Blocks.math_constant = {
    init: function() {
        ...
        this.setColour(Blockly.Blocks.math.HUE);
        this.setOutput(!0, "Number");
        this.appendDummyInput().appendField(new Blockly.FieldDropdown([["\u03c0", "PI"], ["e", "E"], ["\u03c6", "GOLDEN_RATIO"], ["sqrt(2)", "SQRT2"], ["sqrt(\u00bd)", "SQRT1_2"], ["\u221e", "INFINITY"]]), "CONSTANT");
...
Blockly.Blocks.procedures_callnoreturn = {
    ...
    renameVar: function(a, b) {
        for (var c = 0; c < this.arguments_.length; c++) Blockly.Names.equals(a, this.arguments_[c]) && (this.arguments_[c] = b, this.getInput("ARG" + c).fieldRow[0].setValue(b))
    },
    customContextMenu: function(a) {
        var b = {
            enabled: !0
...
Blockly.Blocks.text = {
    init: function() {
        ...
        this.setTooltip(function() {
            var b = a.getParent();
            return b && b.tooltip || Blockly.Msg.TEXT_TEXT_TOOLTIP
        })
    },
...
Blockly.Blocks.text_prompt_ext = {
    ...
    updateType_: function(a) {
        "NUMBER" == a ? this.outputConnection.setCheck("Number") : this.outputConnection.setCheck("String")
    },
    mutationToDom: function() {
        var a = document.createElement("mutation");
